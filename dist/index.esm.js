...
const textSkeleton = element => /*#__PURE__*/createElement('span', {
  style: {
    ...baseSkeletonStyle,
...
const imageSkeleton = (style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'inline-block',
...
const inputSkeleton = (type, style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'inline-block',
...
const videoSkeleton = (style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'block',
...
const audioSkeleton = (style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'block',
...
const svgSkeleton = (style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'inline-block',
...
const canvasSkeleton = (style, rest) => /*#__PURE__*/createElement('div', {
  ...rest,
  style: {
    ...baseSkeletonStyle,
    display: 'inline-block',
